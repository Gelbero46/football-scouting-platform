  ...
  useEffect(() => {
    const fetchCoach = async () => {
      try {
        ...
        const response = await api.coaches.get(params.id)
        ...
        const safeCoach = Object.fromEntries(
          Object.entries(coach).map(([k, v]) => [k, v ?? ""])
        )
        console.log("safeCoach", safeCoach)
  
        
        // ✅ Reset after ensuring types match the form
        form.reset(safeCoach as CoachFormValues)
      } catch (err) {
